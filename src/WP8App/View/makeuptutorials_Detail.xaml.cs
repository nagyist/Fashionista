...
{
    /// <summary>
    /// Phone application page for makeuptutorials_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class makeuptutorials_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for makeuptutorials_Detail and all its components.
        /// </summary>
        public makeuptutorials_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramamakeuptutorials_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramamakeuptutorials_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramamakeuptutorials_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramamakeuptutorials_Detail(Panoramamakeuptutorials_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramamakeuptutorials_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Imakeuptutorials_makeupfeed>();
				AddHomeAppBarButton();
				...
				((IViewModels.Imakeuptutorials_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}

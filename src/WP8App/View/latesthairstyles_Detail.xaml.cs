...
{
    /// <summary>
    /// Phone application page for latesthairstyles_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class latesthairstyles_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for latesthairstyles_Detail and all its components.
        /// </summary>
        public latesthairstyles_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramalatesthairstyles_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramalatesthairstyles_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramalatesthairstyles_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramalatesthairstyles_Detail(Panoramalatesthairstyles_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramalatesthairstyles_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Ilatesthairstyles_hairstylefeed>();
				AddHomeAppBarButton();
				...
				((IViewModels.Ilatesthairstyles_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}

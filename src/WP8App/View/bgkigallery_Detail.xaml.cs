...
{
    /// <summary>
    /// Phone application page for bgkigallery_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class bgkigallery_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for bgkigallery_Detail and all its components.
        /// </summary>
        public bgkigallery_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramabgkigallery_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramabgkigallery_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramabgkigallery_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramabgkigallery_Detail(Panoramabgkigallery_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramabgkigallery_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.Ibgkigallery_bgkitumblrfeed>();
				AddHomeAppBarButton();
				...
				((IViewModels.Ibgkigallery_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}

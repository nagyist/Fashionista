...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.Iinfo_InfoViewModel), "/View/info_Info.xaml" },
            { typeof(IViewModels.Imakeuptutorials_DetailViewModel), "/View/makeuptutorials_Detail.xaml" },
            { typeof(IViewModels.Ilatesthairstyles_DetailViewModel), "/View/latesthairstyles_Detail.xaml" },
            { typeof(IViewModels.Ibgkigallery_DetailViewModel), "/View/bgkigallery_Detail.xaml" },

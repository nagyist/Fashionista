...
namespace WPAppStudio.Repositories
{
    ...
    public class bgkigallery_bgkitumblrfeed : Ibgkigallery_bgkitumblrfeed 
    {
		...
		private const string RssUrl = "http://blackandkillingit.com/rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="bgkigallery_bgkitumblrfeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public bgkigallery_bgkitumblrfeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://blackandkillingit.com/rss), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("bgkigallery_bgkitumblrfeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("bgkigallery_bgkitumblrfeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://blackandkillingit.com/rss), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>

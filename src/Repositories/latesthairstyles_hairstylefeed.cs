...
namespace WPAppStudio.Repositories
{
    ...
    public class latesthairstyles_hairstylefeed : Ilatesthairstyles_hairstylefeed 
    {
		...
		private const string RssUrl = "http://latest-hairstyles.tumblr.com/rss";

        /// <summary>
        /// Initializes a new instance of the <see cref="latesthairstyles_hairstylefeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public latesthairstyles_hairstylefeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://latest-hairstyles.tumblr.com/rss), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("latesthairstyles_hairstylefeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("latesthairstyles_hairstylefeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://latest-hairstyles.tumblr.com/rss), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>

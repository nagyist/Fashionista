...
namespace WPAppStudio.Repositories
{
    ...
    public class makeuptutorials_makeupfeed : Imakeuptutorials_makeupfeed 
    {
		...
		private const string RssUrl = "http://www.makeupgeek.com/category/tutorials/feed/";

        /// <summary>
        /// Initializes a new instance of the <see cref="makeuptutorials_makeupfeed" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public makeuptutorials_makeupfeed(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.makeupgeek.com/category/tutorials/feed/), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("makeuptutorials_makeupfeed", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("makeuptutorials_makeupfeed");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.makeupgeek.com/category/tutorials/feed/), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
